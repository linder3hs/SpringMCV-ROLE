...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	public Employee findEmployee(int employee_id) throws DAOException, EmptyResultException {
		...
		String query ="SELECT employees.employee_id, employees.login, employees.password, employees.first_name, employees.last_name, employees.salary, employees.department_id, employees_roles.login, employees_roles.role FROM employees JOIN  employees_roles ON employees.login=employees_roles.login WHERE employees.employee_id = ?";
	...
	public void deleterole(String login) throws DAOException {
		...
		String query = "DELETE FROM employees_roles role = ?" ;
		Object[] params = new Object[] { login };
...
//		Object[] params = new Object[] { password, lastname, firstname, salary, dptId, login };
	...
	@Override
	public void updateRole(String login, String password, String lastname, String firstname, int salary, int dptId, Role role)
			throws DAOException {
		String query = "UPDATE employees SET password = ?, first_name =?, last_name = ?, salary = ? WHERE login = ?";
	...
	public List<Employee> findAllEmployees() throws DAOException, EmptyResultException {
		...
		String query = "SELECT employees.employee_id, employees.login, employees.password, employees.first_name, employees.last_name, employees.salary, employees.department_id, employees_roles.login, employees_roles.role FROM employees JOIN  employees_roles ON employees.login=employees_roles.login";
